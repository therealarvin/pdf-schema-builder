...
// Stub functions for missing database queries
const getDealPartiesByDealId = async (dealId: string): Promise<Array<{
  id: string;
  party_email: string;
  party_role: string;
}>> => {
...
const getDealPartiesByDealOptionId = async (dealOptionId: string): Promise<Array<{
  id: string;
  party_email: string;
  party_role: string;
}>> => {
