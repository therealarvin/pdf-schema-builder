        ...
        {selectedLog ? (
          <div>
            ...
            <div style={{ fontSize: '14px' }}>
              ...
              {selectedLog.openAISent !== undefined && (
                <div style={{ marginBottom: '12px' }}>
                  ...
                  <pre style={{
                    ...
                    {JSON.stringify(selectedLog.openAISent, null, 2)}
                  </pre>
                </div>
              )}

              {selectedLog.openAIReceived !== undefined && (
                <div style={{ marginBottom: '12px' }}>
                  ...
                  <pre style={{
                    ...
                    {JSON.stringify(selectedLog.openAIReceived, null, 2)}
                  </pre>
                </div>
              )}
